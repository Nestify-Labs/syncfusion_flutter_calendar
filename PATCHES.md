...
| `main` | Default development branch. Based on the latest `upstream/<major>.<minor>.x` plus the Nestify patches listed below (SF-1 … SF-14). Excludes upstream `example/`, `screenshots/`, and `*.iml`. |
